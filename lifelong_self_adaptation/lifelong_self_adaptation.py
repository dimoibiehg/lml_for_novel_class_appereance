...
class LifelongSelfAdaptation:
    ...
    def start(self):
        ...
        for i in tqdm(range(1, self.mape_cycle_len)):
            if(((i % self.cycle_len) == 1) and i > 1):
                # task identification
                out_of_class_counter = 0
                out_of_class_indices = []
                start_idx = (i-1-self.cycle_len) * self.mape.feature_size
                end_idx = (i-1) * self.mape.feature_size
                ...
                if(out_of_class_percentage > self.percentage_out_of_class_threshold):
                    ...
                    if(counter_detection == 2):
                        ...
                        store_in_pickle("./files/classifiers.pkl", self.mape.classifiers)
